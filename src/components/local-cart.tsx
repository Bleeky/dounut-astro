        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8">
            ...
            {total === 0 ? (
              ...
              <div className="mt-8 flex justify-end border-t border-teal-100 pt-8">
                <div className="w-screen max-w-lg space-y-4">
                  ...
                  <div className="flex justify-end">
                    <a
                      href="/checkout"
                      className="block rounded bg-teal-600 px-5 py-3 text-sm text-white transition hover:bg-gray-600"
                    >
                      Checkout
                    </a>
                  </div>
